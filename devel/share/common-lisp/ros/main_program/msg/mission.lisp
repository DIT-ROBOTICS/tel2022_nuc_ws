...
(cl:in-package main_program-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <mission>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'mission)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name main_program-msg:<mission> is deprecated: use main_program-msg:mission instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <mission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_program-msg:type-val is deprecated.  Use main_program-msg:type instead.")
  (type m))

(cl:ensure-generic-function 'T-val :lambda-list '(m))
(cl:defmethod T-val ((m <mission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_program-msg:T-val is deprecated.  Use main_program-msg:T instead.")
  (T m))

(cl:ensure-generic-function 'E-val :lambda-list '(m))
(cl:defmethod E-val ((m <mission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_program-msg:E-val is deprecated.  Use main_program-msg:E instead.")
  (E m))

(cl:ensure-generic-function 'L-val :lambda-list '(m))
(cl:defmethod L-val ((m <mission>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader main_program-msg:L-val is deprecated.  Use main_program-msg:L instead.")
  (L m))
