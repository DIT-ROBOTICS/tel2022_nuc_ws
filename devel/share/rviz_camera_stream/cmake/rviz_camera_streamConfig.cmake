...
if("TRUE" STREQUAL "TRUE")
  set(rviz_camera_stream_SOURCE_PREFIX /home/dit_nuc/tel2022_nuc_ws/src/rviz_camera_stream)
  set(rviz_camera_stream_DEVEL_PREFIX /home/dit_nuc/tel2022_nuc_ws/devel)
  ...
  set(rviz_camera_stream_INSTALL_PREFIX /home/dit_nuc/tel2022_nuc_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_camera_stream' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dit_nuc/tel2022_nuc_ws/src/rviz_camera_stream/${idir}'.  ${_report}")
    endif()
